<?php
    include 'db.php';
    $mimin = mysqli_query($conn, "SELECT admin_telpon, admin_email, admin_address FROM tb_admin WHERE admin_id = 2");
    $row = mysqli_fetch_assoc($mimin);
...
<body>
   <!-- Header -->
    <header>
        <div class="container">
        <h1><a href="index.php">Luv Book</a></h1>
        <ul>
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="box">
                ...
                ?>
                    <a class="itemcategory" href="buku.php?kat=<?php echo $k['category_id'] ?>">
                        <div class="col-5">
    ...
    <div class="footer">
        <div class="container">
            <h4>Alamat</h4>
            <p><?=$row['admin_address']?></p>

            <h4>Email</h4>
            <p><?=$row['admin_email']?></p>

            <h4>Telepon</h4>
            <p><?=$row['admin_telpon']?></p>

            <small>Copyright &copy; 2020 - Lucy Peng.</small>
        </div>
    </div>
</body>
</html>